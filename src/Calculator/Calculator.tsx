...
function Calculator(props: ICalculatorProp) {
    ...
    const handleInputButtonClick =  useCallback((input: string) => {
      setNumberOnScreen((numberOnScreen) => {
        ...
        if(numberOnScreen.indexOf('.') === -1 && numberOnScreen.length >= maxDigits && input !== '.') {
    ...
    return(
        <div>
            ...
            <Button className="no-side-borders" onClick={handleInputButtonClick}>8</Button>
            <Button onClick={handleInputButtonClick}>9</Button>
            <Button onClick={handleOnBackspaceClick}>←</Button>
            <br />
            <Button onClick={handleInputButtonClick} className="no-top-border">4</Button>
            <Button className="no-side-borders no-top-border" onClick={handleInputButtonClick}>5</Button>
            <Button onClick={handleInputButtonClick} className="no-top-border">6</Button>
            <br />
            <Button onClick={handleInputButtonClick} className="no-top-border">1</Button>
            <Button className="no-side-borders no-top-border" onClick={handleInputButtonClick}>2</Button>
            <Button onClick={handleInputButtonClick} className="no-top-border">3</Button>
            <br />
            <Button onClick={handleInputButtonClick} className="no-top-border">0</Button>
            <Button className="no-side-borders no-top-border" onClick={handleInputButtonClick}>.</Button>
            <Button onClick={handleCalculateButtonClick} className="no-top-border">=</Button>
        </div>
    );
}
